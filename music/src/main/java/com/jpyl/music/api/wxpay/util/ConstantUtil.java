...
public class ConstantUtil {
    ...
    //初始化
    public static String APP_ID = "wxb3150be9c56b7eb3";//微信开发平台应用id
    public static String APP_SECRET = "2206dfa3b64924b123cf9144f449fcdf";//应用对应的凭证
    //应用对应的密钥
    ...
    public static String PARTNER = "1340516001";//财付通商户号
